    ...
    <div className="min-h-screen bg-snow flex flex-col font-sans">
      <header className="glass-header">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <Link href="/site" className="flex items-center gap-2">
            <img src="/logo-evolves.svg" alt="Evolves Logo" className="w-8 h-8" />
            <span className="text-xl font-bold text-ink">Evolves<span className="text-teal-mid">.</span></span>
          </Link>
      ...
      <footer className="bg-ink text-fog py-12 border-t border-white/10 mt-auto">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              <img src="/logo-evolves.svg" alt="Evolves Logo" className="w-6 h-6 brightness-0 invert opacity-80" />
              <span className="text-lg font-bold text-white">Evolves<span className="text-teal-mid">.</span></span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between text-xs text-slate">
          <p>© 2026 Evolves. Todos os direitos reservados.</p>
